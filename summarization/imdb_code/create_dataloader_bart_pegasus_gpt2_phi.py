...
- Model index
- Model family (BART, Pegasus, GPT-2, Phi)
- Model size (base, large, xsum, small, medium, 1.5)
...
class DataLoaderCreator:
    ...
    Supports BART, Pegasus, GPT-2, and Phi models with their respective configurations.
    """
    ...
    def __init__(self, data_dir: str = "./multimodal_dataset", config_path: str = "./configs/config_summary.csv"):
        ...
        # Based on actual config_summary.csv, BART, Pegasus, GPT-2, and Phi models are present
        # GPT-2 models include: small (gpt2), medium (gpt2-medium), large (gpt2-large)
        # Phi models include: 1.5 (phi-1.5)
        self.model_family_mapping = ['BART', 'Pegasus', 'GPT-2', 'Phi']
        self.model_size_mapping = ['base', 'large', 'xsum', 'small', 'medium', '1.5']
    ...
    def validate_label_mappings(self):
        ...
        expected_families = ['BART', 'Pegasus', 'GPT-2', 'Phi']
        ...
        expected_sizes = ['base', 'large', 'xsum', 'small', 'medium', '1.5']
...
def main():
    ...
    try:
        ...
        logger.info("Expected model families: BART, Pegasus, GPT-2, Phi")
        logger.info("Expected model sizes: base, large, xsum, small, medium, 1.5")
