...
- max_source_length = 1024 # for GPT-2 large tryoing with 512, others are finetuned with 1024
...
def train_gpt2_model(config_path: str, model_index: int) -> None:
    ...
    try:
        ...
        # Configure training arguments with GPT-2-specific settings and A100 optimizations
